...
<script>
  import {fetchList,createFlashProductRelation,createFlashProductRelations,deleteFlashProductRelation,updateFlashProductRelation} from '@/api/flashProductRelation';
    ...
    methods:{
      ...
      handleSelectDialogConfirm(){
        ...
        this.$confirm('使用要进行添加操作?', '提示', {
          ...
          createFlashProductRelations(selectProducts).then(response=>{
