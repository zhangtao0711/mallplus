<template> 
    <div class="app-container">
        ...
        <el-card class="operate-container" shadow="never">
            ...
            <el-button
                    class="btn-add"
                    @click="addSmsWaterPage()"
                    size="mini">
                添加
            </el-button>
        </el-card>
        <div class="table-container">
            <el-table ref="smsWaterPageTable"
                      :data="list"
                      style="width: 100%"
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.$router.push(
                    {path: '/sms/updateSmsWaterPage', query: {id: row.id}})
            },
            ...
            addSmsWaterPage() {
                //手动将router,改成$router
                this.$router.push({path: '/sms/addSmsWaterPage'})
            }
        }
    }
</script>
