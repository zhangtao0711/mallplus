  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item label="店内分类：" prop="storeClassId">
        <el-select v-model="value.storeClassId" placeholder="请选择店内分类">
          <el-option
      ...
      <el-form-item label="计量单位：">
        <el-select v-model="value.unit" placeholder="请选择计量单位">
          <el-option v-for="item in unitOptions" :key="item.id" :label="item.id" :value="item.id"></el-option>
        </el-select>
      </el-form-item>
