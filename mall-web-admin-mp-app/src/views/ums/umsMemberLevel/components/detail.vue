    ...
    <el-card class="form-container" shadow="never">
        <el-form :model="umsMemberLevel" :rules="rules" ref="UmsMemberLevelFrom" label-width="150px">
                    ...
                    <el-form-item
                            label="id"
                            prop="id">
                        <el-input v-model="umsMemberLevel.id" style="width: 370px;"/>
                    </el-form-item>
...
<script>
    import {createUmsMemberLevel, getUmsMemberLevel, updateUmsMemberLevel} from '@/api/ums/umsMemberLevel'
            ...
            onSubmit(formName) {
                this.$refs[formName].validate((valid) => {
                    if(valid) {
                        ...
                        {
                            updateUmsMemberLevel(this.$route.query.id, this.umsMemberLevel).then(response => {
