<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button type="primary" size="small">取款</el-button>
    </el-card>
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column prop="umsMemberReferrerName" label="推荐人" align="center">
          <template slot-scope="scope">{{scope.row.umsMemberReferrerName }}</template>
        </el-table-column>
