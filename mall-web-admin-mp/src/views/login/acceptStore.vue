      ...
      <el-form autoComplete="on"
        ...
        <el-form-item prop="name">
         ...
         <el-form-item
                                    label="负责人"
                                    prop="contactName">
                                <el-input v-model="storeForm.contactName" style="width: 370px;"/>
                            </el-form-item>
        ...
        <el-form-item prop="contactQq">
         ...
         <el-form-item label="身份证照：" prop="servicePhone">
                                              <single-upload v-model="storeForm.servicePhone"></single-upload>
                                            </el-form-item>
                           ...
                           <el-form-item
                                                      ...
                                                      prop="contactMobile">
                                                  <el-input v-model="storeForm.contactMobile" style="width: 370px;" placeholder="请输入服务电话"/>
                                              </el-form-item>
