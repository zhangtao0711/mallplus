...
public class AppletMemberController extends ApiBaseAction {
    ...
    public Object index() {
        ...
        try {
            ...
            TArticleDO c4 = new TArticleDO("我的订单", "/pages/order/order?status=12", "navigate", "http://www.91weiyi.xyz/addons/zjhj_mall/core/web/uploads/image/7c/7c80acbbd479b099566cc6c3d34fbcb8.png");
            ...
            TArticleDO c8 = new TArticleDO("售后订单", "/pages/order/order?status=12", "navigate", "http://www.91weiyi.xyz/addons/zjhj_mall/core/web/uploads/image/cf/cfb32a65d845b4e9a9778020ed2ccac6.png");
