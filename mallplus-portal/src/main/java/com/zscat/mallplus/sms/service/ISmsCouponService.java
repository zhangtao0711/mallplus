...
import com.zscat.mallplus.sms.entity.SmsBargainMember;
...
public interface ISmsCouponService extends IService<SmsCoupon> {
     ...
     * 根据购物车信息获取可用优惠券
     */
    List<SmsCouponHistoryDetail> listCart(List<OmsCartItem> cartItemList, Integer type,Integer storeId);
    ...
    void insertBarginRe(SmsBargainRecord groupRecords, SmsBargainMember query);
}
