...
public class OssAliyunUtil {
     ...
     * @return
     */
    public String upload(String suffix,  File imgFile, String filePath) {
        return upload(defaultOssAliyunField, getKey(defaultOssAliyunField.getPrefix(), suffix), imgFile,filePath);
    }
    /**
     * 上传文件
     *
    ...
    public String upload(OssAliyunField field, String key, File imgFile, String filePath) {
        return upload(field.getAccessKeyId(), field.getAccessKeySecret(), field.getBucketName(), field
                .getEndPoint(), field.getStyleName(), key, imgFile,filePath);
    }
    /**
     * 上传文件<>基础方法</>
     *
    ...
    public String upload(String accessKeyId, String accessKeySecret, String bucketName, String endpoint, String
            styleName, String key, File imgFile, String filePath) {
