...
public class WtEquipment extends BaseEntity implements Serializable {
     ...
     * 当月销售额
     */
    private transient BigDecimal salesVolumeOfMon;
    /**
     * 设备详情id
     **/
    private transient String dtailesId;
    /**
     * 软件版本
     **/
     ...
     * 当前信号强度
     **/
    private transient Integer sig;


    /**
     * 当前温度（40=4.0℃）
     **/
    private transient Integer wd;
    /**
     ...
     * SIM卡
     */
    private transient String simCardNo;
    /**
     * 最后上报时间
     */
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private transient Date setUpTime;
     ...
     * 会员数
     **/
    private transient Integer userNum;
