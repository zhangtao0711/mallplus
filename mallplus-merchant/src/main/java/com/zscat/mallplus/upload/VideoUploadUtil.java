...
public class VideoUploadUtil {
    ...
    private static final String uploadUrl = "https://api.mch.weixin.qq.com/v3/merchant/media/video_upload";
...
//        httpPost.setHeader("Content-Type", "application/json");
        ...
        //设置图片内容
        multipartEntityBuilder.addBinaryBody("file", file, ContentType.create("video/mp4"), file.getName());
        //放入内容
