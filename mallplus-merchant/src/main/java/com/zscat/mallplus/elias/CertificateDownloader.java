package com.zscat.mallplus.elias;


import com.zscat.mallplus.elias.cert.CertificateItem;
import com.zscat.mallplus.elias.cert.CertificateList;
import com.zscat.mallplus.elias.cert.PlainCertificateItem;
import com.zscat.mallplus.elias.config.CertPathConfig;
import com.zscat.mallplus.elias.util.JsonUtils;
import com.zscat.mallplus.sdk.Validator;
import com.zscat.mallplus.sdk.WechatPayHttpClientBuilder;
import com.zscat.mallplus.sdk.auth.CertificatesVerifier;
import com.zscat.mallplus.sdk.auth.Verifier;
import com.zscat.mallplus.sdk.auth.WechatPay2Validator;
import com.zscat.mallplus.sdk.util.AesUtil;
...
public class CertificateDownloader implements Runnable {
    ...
    private List<PlainCertificateItem> downloadCertificate() throws IOException, GeneralSecurityException {
        ...
        if (wechatpayCertificatePath == null || wechatpayCertificatePath.trim().equals("")) {
            //不做验签
...
//        CommandLine.run(certificateDownloader, args);
        certificateDownloader.run();
    }
}